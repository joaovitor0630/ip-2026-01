...
func main() {
    ...
    // Define a rota "/cadastrar" para cadastrar um novo aluno
    http.HandleFunc("/cadastrar", handlers.CadastrarHandler)

    // Define a rota "/consultar" para consultar um aluno por matrícula
    http.HandleFunc("/consultar", handlers.ConsultarHandler)

    // Define a rota "/atualizar" para atualizar os dados de um aluno
    http.HandleFunc("/atualizar", handlers.AtualizarHandler)

    // Define a rota "/remover" para remover um aluno
    http.HandleFunc("/remover", handlers.RemoverHandler)
